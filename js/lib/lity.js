(function(window, factory) {
    ...
    var _defaultOptions = {
        esc: true,
        handler: null,
        template: '<div class="lity" tabindex="-1"><div class="lity-wrap" data-lity-close><div class="lity-loader">Loading...</div><div class="lity-container"><div class="lity-content"></div><button onClick="return_scroll()" class="lity-close bg-white icon-box icon-plusRotate cicon-colorBlack" type="button" title="Close (Esc)" data-lity-close></button></div></div></div>'
    };
